...
function spawn(command, params, errorMessage) {
    ...
    if (result.status !== 0) {
        console.error(chalk_1["default"](templateObject_1 || (templateObject_1 = __makeTemplateObject(["{red.bold ", "}"], ["{red.bold ", "}"])), errorMessage));
...
function build(env) {
    ...
    console.info(chalk_1["default"](templateObject_2 || (templateObject_2 = __makeTemplateObject(["{green.bold [task]} {white.bold check code style}"], ["{green.bold [task]} {white.bold check code style}"]))));
    ...
    console.info(chalk_1["default"](templateObject_3 || (templateObject_3 = __makeTemplateObject(["{green.bold [task]} {white.bold cleanup ", "}"], ["{green.bold [task]} {white.bold cleanup ", "}"])), env.output));
    fs_extra_1["default"].emptyDirSync(env.output);
    console.info(chalk_1["default"](templateObject_4 || (templateObject_4 = __makeTemplateObject(["{green.bold [task]} {white.bold copy ", " folder to ", "}"], ["{green.bold [task]} {white.bold copy ", " folder to ", "}"])), env.contentBase, env.output));
    fs_extra_1["default"].copySync(env.contentBase, env.output, { dereference: true });
    console.info(chalk_1["default"](templateObject_5 || (templateObject_5 = __makeTemplateObject(["{green.bold [task]} {white.bold webpack}"], ["{green.bold [task]} {white.bold webpack}"]))));
    ...
    compiler.run(function (error, stats) {
        ...
        if (error) {
            ...
            if (env.profile) {
                console.info(chalk_1["default"](templateObject_6 || (templateObject_6 = __makeTemplateObject(["{green.bold [task]} write stats.json"], ["{green.bold [task]} write stats.json"]))));
                fs_extra_1["default"].writeFileSync("stats.json", JSON.stringify(statsJSON, null, 2));
            }
            if (statsJSON.errors.length) {
                console.error(chalk_1["default"](templateObject_7 || (templateObject_7 = __makeTemplateObject(["{red.bold \n", " Error(s) Occurred:}\n"], ["{red.bold \\n", " Error(s) Occurred:}\\n"])), statsJSON.errors.length));
                console.error(chalk_1["default"](templateObject_8 || (templateObject_8 = __makeTemplateObject(["{red.bold ", "}"], ["{red.bold ", "}"])), statsJSON.errors.join("\n\n")));
                process.exit(1);
            }
                ...
                if (warnings.length > 0) {
                    console.error(chalk_1["default"](templateObject_9 || (templateObject_9 = __makeTemplateObject(["{red.bold \n", " Warning(s) Occurred:}\n"], ["{red.bold \\n", " Warning(s) Occurred:}\\n"])), warnings.length));
                    console.error(chalk_1["default"](templateObject_10 || (templateObject_10 = __makeTemplateObject(["{red.bold ", "}"], ["{red.bold ", "}"])), warnings.join("\n\n")));
                    process.exit(1);
                }
            }
            console.info(chalk_1["default"](templateObject_11 || (templateObject_11 = __makeTemplateObject(["{white.bold Build successfully}"], ["{white.bold Build successfully}"]))));
        }
    });
    return;
}
